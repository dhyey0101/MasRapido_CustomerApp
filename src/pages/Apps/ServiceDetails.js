...
var todayForNextDate = new Date();
const currentDayInMilli = new Date(todayForNextDate).getTime();
...
export default class IndicationScreen extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            time: '',
            day: t(moment(today).format('dddd')),
            user_name: '',
            // cashBox: '',
            // walletBox: '',
            dataSource: [],
        ...
        var constraints = {
            selectedsubcategorycapacity: {
                presence: {
                    ...
                    // message: "^ " + t("Select Service Type"),
                    message: "^ " + t("Select Service Capacity"),
                },
            },
        };
    ...
    _handleBackButtonClick = () => this.props.navigation.navigate('Service')
    ...
    async Capacity(item_id, item_label, item_type, status) {
    ...
    async Save() {
        ...
        if (walletBox == 1) {
            ...
            if (!serviceCost) {
                this.refs.defaultToastBottomWithDifferentColor.ShowToastFunction(t("Please select service capacity type"));
                ...
                if (parseFloat(dataSource.balance) < parseFloat(serviceCost)) {
                    this.refs.defaultToastBottomWithDifferentColor.ShowToastFunction(t("Wallet amount not sufficient"));
    ...
    render() {
        ...
        if (this.state.selectedPaymentMethod == "card") {
            var paymentMethod = t('card name')
        } else if (this.state.selectedPaymentMethod == "wallet") {
            var paymentMethod = t('Wallet')
        } else {
            var paymentMethod = ''
        }
                    ...
                    >
                        <Row style={{ height: normalize(35), }}>
                            ...
                            <Col style={{ justifyContent: 'center', }}>
                                <Text style={{ fontSize: 22, fontFamily: 'Inter-Black', color: '#c2272e', }} numberOfLines={1}>{userData.first_name}</Text>
                            </Col>
                        </Row>
                        ...
                        <Collapse style={styles.service_colls}
                            isCollapsed={this.state.serviceCollapsed}
                            onToggle={(isCollapsed) => this.setState({ serviceCollapsed: isCollapsed })}>
                            <CollapseHeader>
                        ...
                        <Collapse style={styles.detail_colls}
                            isCollapsed={this.state.capacityCollapsed}
                            onToggle={(isCollapsed) => this.setState({ capacityCollapsed: isCollapsed })}>
                            <CollapseHeader>
                            ...
                            <CollapseBody>
                                <Row style={{ height: normalize(50), paddingLeft: normalize(15), marginTop: normalize(5), borderBottomWidth: 1, borderColor: '#e5e5e5' }}>
                                    {residentialEnable ? (
                                        <TouchableOpacity onPress={() => this.SelectPlace('residential')}>
                                    ...
                                    {commercialEnable ? (
                                        <TouchableOpacity onPress={() => this.SelectPlace('commercial')}>
                                ...
                                {this.state.ServiceSubCategory.map(((item) => (
                                    <Collapse
                                        ...
                                        onToggle={(status) => this.Capacity(item.id, item.label, item.type,status)}
                                        ...
                                        <CollapseHeader>
                                                ...
                                                <Row style={{ height: normalize(25), marginTop: normalize(5), alignItems: 'center', }}>
                                                    ...
                                                    <Col style={styles.down_arrow}>
                                                        {this.state.lastcollapsid == item.id ? (
                                                            <Image style={{ height: normalize(16), width: normalize(16) }}
                                                                source={require('../../images/Up_Arrow.png')}
                                                            />
                                                        ) : (
                                                    ...
                                                    <View>
                                                        {
                                                            this.state.getCapacity.map(((capacity) => (
                                                                ...
                                                                <Col style={{ marginTop: normalize(15) }}>
                                                                    <TouchableOpacity onPress={() => this.setState({ selectedcapacityid: capacity.id })}>
                                ...
                                <TouchableOpacity onPress={() => this.getCost()}>
                                    <Row style={{ height: normalize(30), marginTop: normalize(35), justifyContent: 'center', marginBottom: normalize(30) }}>
                                        <Col style={{ backgroundColor: '#1988B9', width: normalize(115), borderRadius: normalize(12), justifyContent: 'center', alignItems: 'center', }}>
                        ...
                        <Row style={styles.notes_Row}>
                            ...
                            <Row style={{ height: normalize(25), paddingLeft: 5}}>
                            ...
                            <Row style={{ height: normalize(45), marginTop: normalize(15), marginLeft: normalize(20), marginRight: normalize(20), }}>
                                ...
                                <TouchableOpacity style={{ backgroundColor: '#efefef', borderRadius: normalize(30), width: normalize(150), marginRight: normalize(33), justifyContent: 'center', alignItems: 'center', }}>
                                    <DateTimePicker
                                        ...
                                        onDateChange={(date) => { this.IOSsetdate(date) }}
                                    />
                                </TouchableOpacity>
                        ...
                        <Row style={{ height: normalize(20), marginLeft: normalize(40), marginTop: normalize(10), marginBottom: normalize(10) }}>
                            <Text style={{ color: '#c2272e', fontSize: 11, fontFamily: 'Inter-Black', }}>{t('All appointments must be requested with an advance (24) hours')}</Text>
                        </Row>
                            ...
                            <View>
                                <TouchableOpacity onPress={() => { this.setModalPaymentType(true); }}>
                                    <Row style={styles.payment_row}>
                                        ...
                                        <Col>
                                            <Text style={styles.payment_name}>{paymentMethod}</Text>
                                        </Col>
                                        <Col style={styles.down_arrow}>
                                            <Image style={{ height: normalize(16), width: normalize(16) }}
                                    ...
                                    <ScrollView showsVerticalScrollIndicator={false}>
                                            ...
                                            <View>
                                                ...
                                                <View>
                                                    <Collapse style={styles.Accordion1}
                                                        ...
                                                        onToggle={(isCollapsed) => this.setState({ collapsed: !this.state.collapsed, selectedPaymentMethod: '', walletBox: 0 })}
                                                    >
                                                        {(collapsed == true) ? (
                                                            <CollapseHeader >
                                                                <Row style={styles.ModalNotes}>
                                                        ...
                                                        < CollapseBody >
                                                            <Col style={{ marginLeft: 20, marginRight: 20, }}>
                                                                <TextInput style={styles.TextValue}
                                                                    ...
                                                                    autoComplete={false}
                                                                    value={user_name}
                                                                    onChangeText={(user_name) => this.setState({ user_name: user_name, walletBox: 0, })}>
                                                                </TextInput>
                                                                <TextInput style={styles.TextValue}
                                        ...
                                        <Row style={{ marginTop: "5%", marginLeft: 20, marginRight: 20, }}>
                                            <Text style={{ fontSize: 12, color: "#8d8d8d", fontFamily: "Inter-Black" }}>
                                                {t('The cash payment method is not available to request technical appointments')}
                                            </Text>
                                        </Row>

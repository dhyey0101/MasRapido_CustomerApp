...
export default class MenuChatWithAdmin extends Component {
  constructor(props) {
    super(props);
    this.recording = null;
    this.sound = null;
  ...
  _handleBackButtonClick = () => this.props.navigation.navigate("ViewOrderDetails", { order_id: this.state.order_id })
